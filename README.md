...
<div style="display: flex; justify-content: space-evenly; flex-wrap: wrap; gap:10px">
  ...
  <a href="#/notes/hadoop高可用搭建.md" style="text-decoration: none; width: 280px; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: rgba(240, 250, 240, 0.42); box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); text-align: center;margin-top:30px;">
    <h4 style="color: #333;">Hadoop高可用搭建</h4>
